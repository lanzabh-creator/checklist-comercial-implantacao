...
export interface ConditionalField {
  id: string
  label: string
  type: 'text' | 'textarea' | 'pdf_upload' | 'drive_upload'
  ph?: string
}
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { id: 'razao_social', label: 'Razão Social', type: 'text', ph: 'Ex: Grupo Madero Restaurantes S.A.' },
          { id: 'nome_fantasia', label: 'Nome Fantasia', type: 'text', ph: 'Ex: Madero' },
      ...
      {
        id: 'antes_depois', title: 'Antes & Depois',
        desc: 'Preencha a coluna "Antes" no início do projeto. A coluna "Depois" deve ser preenchida meses após a implantação para medir o impacto real dos sistemas Teknisa.',
        fields: [
          { id: 'ad_fat_antes', label: 'Faturamento — Antes', type: 'text', ph: 'Ex: R$ 2,5 milhões/mês' },
          { id: 'ad_fat_depois', label: 'Faturamento — Depois', type: 'text', ph: 'Ex: R$ 3,1 milhões/mês' },
          { id: 'ad_margem_antes', label: 'Margem Operacional — Antes', type: 'text', ph: 'Ex: 18%' },
          { id: 'ad_margem_depois', label: 'Margem Operacional — Depois', type: 'text', ph: 'Ex: 23%' },
          { id: 'ad_cmv_antes', label: 'CMV — Antes', type: 'text', ph: 'Ex: 35%' },
          { id: 'ad_cmv_depois', label: 'CMV — Depois', type: 'text', ph: 'Ex: 28%' },
          { id: 'ad_desperdicio_antes', label: 'Nível de Desperdício — Antes', type: 'text', ph: 'Ex: 12% da produção' },
          { id: 'ad_desperdicio_depois', label: 'Nível de Desperdício — Depois', type: 'text', ph: 'Ex: 5% da produção' },
          { id: 'ad_ticket_antes', label: 'Ticket Médio de Vendas — Antes', type: 'text', ph: 'Ex: R$ 42,00' },
          { id: 'ad_ticket_depois', label: 'Ticket Médio de Vendas — Depois', type: 'text', ph: 'Ex: R$ 58,00' },
          { id: 'ad_obs_antes', label: 'Observações adicionais — Antes', type: 'textarea', ph: 'Outros indicadores ou contexto relevante do momento pré-implantação...' },
          { id: 'ad_obs_depois', label: 'Observações adicionais — Depois', type: 'textarea', ph: 'Outros resultados ou contexto relevante após a implantação...' },
        ],
      },
      {
    ...
    sections: [
      // ── 01 PESQUISA ────────────────────────────────────────
      {
        ...
        fields: [
          ...
          { id: 'coord_email', label: 'Coordenador do Projeto no Cliente — E-mail', type: 'text', ph: 'coordenador@empresa.com.br' },
          { id: 'coord_tel', label: 'Coordenador do Projeto no Cliente — Telefone', type: 'text', ph: '(11) 99999-9999' },
          { id: 'razao_social', label: 'Razão Social', type: 'text', ph: 'Nome da empresa' },
          { id: 'nome_fantasia', label: 'Nome Fantasia', type: 'text', ph: 'Ex: nome pelo qual a empresa é conhecida' },
          { id: 'cnpj', label: 'CNPJ Principal', type: 'text', ph: '00.000.000/0001-00' },
          { id: 'site', label: 'Site Oficial', type: 'text', ph: 'https://www.empresa.com.br' },
          { id: 'linkedin', label: 'LinkedIn (empresa)', type: 'text', ph: 'https://linkedin.com/company/...' },
          { id: 'instagram', label: 'Instagram', type: 'text', ph: 'https://instagram.com/...' },
      ...
      },
      {
        ...
        desc: 'Preencha a coluna "Antes" no início do projeto. A coluna "Depois" deve ser preenchida meses após a implantação para medir o impacto real dos sistemas Teknisa.',
        fields: [
          { id: 'ad_fat_antes', label: 'Faturamento — Antes', type: 'text', ph: 'Ex: R$ 10 milhões/mês' },
          { id: 'ad_fat_depois', label: 'Faturamento — Depois', type: 'text', ph: 'Ex: R$ 13 milhões/mês' },
          { id: 'ad_margem_antes', label: 'Margem Operacional — Antes', type: 'text', ph: 'Ex: 15%' },
          { id: 'ad_margem_depois', label: 'Margem Operacional — Depois', type: 'text', ph: 'Ex: 21%' },
          { id: 'ad_cmv_antes', label: 'CMV — Antes', type: 'text', ph: 'Ex: 42%' },
          { id: 'ad_cmv_depois', label: 'CMV — Depois', type: 'text', ph: 'Ex: 35%' },
          { id: 'ad_desperdicio_antes', label: 'Nível de Desperdício — Antes', type: 'text', ph: 'Ex: 8% da produção' },
          { id: 'ad_desperdicio_depois', label: 'Nível de Desperdício — Depois', type: 'text', ph: 'Ex: 3% da produção' },
          { id: 'ad_ticket_antes', label: 'Ticket Médio de Vendas — Antes', type: 'text', ph: 'Ex: R$ 120,00' },
          { id: 'ad_ticket_depois', label: 'Ticket Médio de Vendas — Depois', type: 'text', ph: 'Ex: R$ 155,00' },
          { id: 'ad_obs_antes', label: 'Observações adicionais — Antes', type: 'textarea', ph: 'Outros indicadores ou contexto relevante do momento pré-implantação...' },
          { id: 'ad_obs_depois', label: 'Observações adicionais — Depois', type: 'textarea', ph: 'Outros resultados ou contexto relevante após a implantação...' },
        ],
      },
      ...
      // ── 08 FINANCEIRO E CONTROLADORIA ──────────────────────
      {
        ...
        fields: [
          ...
          { id: 'dda', label: 'Cliente utiliza pagamento por DDA?', type: 'radio', opts: ['Sim','Não'] },
          { id: 'antecipacao_pagamento', label: 'Cliente trabalha com antecipação de pagamento?', type: 'radio', opts: ['Sim','Não'] },
      ...
      // ── 10 SISTEMAS E INTEGRAÇÕES ──────────────────────────
      {
        ...
        fields: [
          ...
          { id: 'planilhas', label: 'Existem planilhas paralelas ao sistema?', type: 'radio_conditional', opts: ['Sim, muitas','Algumas','Não'], conditionalOpt: 'Sim, muitas|Algumas', conditionalField: { id: 'planilhas_upload', label: 'Enviar planilhas para o Google Drive', type: 'drive_upload' } },
      ...
      // ── 16 RISCOS E GARGALOS ───────────────────────────────
      {
        ...
        fields: [
          ...
          { id: 'concorrencia', label: 'Concorrência em avaliação', type: 'chips_conditional', opts: ['TOTVS','Sankhya','SAP','Oracle','Datasul','Microsiga','Outro'], conditionalOpt: 'Outro', conditionalField: { id: 'concorrencia_outro', label: 'Qual outro concorrente?', type: 'text', ph: 'Nome do concorrente...' } },
          { id: 'risco', label: 'Classificação de Risco Global', type: 'risk_tooltip' },
        ],
      },
      // ── 17 PARECER FINAL DO COMERCIAL ──────────────────────
      {
        ...
        fields: [
          ...
          { id: 'coord_projeto', label: 'Cliente disponibilizará coordenador de projetos?', type: 'radio', opts: ['Sim','Não'] },
          { id: 'coord_projeto_nome', label: 'Coordenador de Projetos — Nome completo', type: 'text', ph: 'Nome completo' },
          { id: 'coord_projeto_email', label: 'Coordenador de Projetos — E-mail', type: 'text', ph: 'email@empresa.com.br' },
          { id: 'coord_projeto_tel', label: 'Coordenador de Projetos — Telefone', type: 'text', ph: '(11) 99999-9999' },
  ...
  tecfood: {
    ...
    sections: [
      ...
      },
      {
        ...
        desc: 'Preencha a coluna "Antes" no início do projeto. A coluna "Depois" deve ser preenchida meses após a implantação para medir o impacto real dos sistemas Teknisa.',
        fields: [
          { id: 'ad_fat_antes', label: 'Faturamento — Antes', type: 'text', ph: 'Ex: R$ 5 milhões/ano' },
          { id: 'ad_fat_depois', label: 'Faturamento — Depois', type: 'text', ph: 'Ex: R$ 6,8 milhões/ano' },
          { id: 'ad_margem_antes', label: 'Margem Operacional — Antes', type: 'text', ph: 'Ex: 12%' },
          { id: 'ad_margem_depois', label: 'Margem Operacional — Depois', type: 'text', ph: 'Ex: 17%' },
          { id: 'ad_cmv_antes', label: 'CMV — Antes', type: 'text', ph: 'Ex: 38%' },
          { id: 'ad_cmv_depois', label: 'CMV — Depois', type: 'text', ph: 'Ex: 30%' },
          { id: 'ad_desperdicio_antes', label: 'Nível de Desperdício — Antes', type: 'text', ph: 'Ex: 15% da produção' },
          { id: 'ad_desperdicio_depois', label: 'Nível de Desperdício — Depois', type: 'text', ph: 'Ex: 6% da produção' },
          { id: 'ad_ticket_antes', label: 'Ticket Médio de Vendas — Antes', type: 'text', ph: 'Ex: R$ 18,00 por refeição' },
          { id: 'ad_ticket_depois', label: 'Ticket Médio de Vendas — Depois', type: 'text', ph: 'Ex: R$ 22,00 por refeição' },
          { id: 'ad_obs_antes', label: 'Observações adicionais — Antes', type: 'textarea', ph: 'Outros indicadores ou contexto relevante do momento pré-implantação...' },
          { id: 'ad_obs_depois', label: 'Observações adicionais — Depois', type: 'textarea', ph: 'Outros resultados ou contexto relevante após a implantação...' },
        ],
      },
      ...
      // ── 12 PROJETO E IMPLANTAÇÃO ───────────────────────────
      {
        ...
        fields: [
          ...
          { id: 'custos_resp_nome', label: 'Responsável ciente — Nome completo', type: 'text', ph: 'Nome completo do responsável ciente' },
          { id: 'custos_resp_email', label: 'Responsável ciente — E-mail', type: 'text', ph: 'email@empresa.com.br' },
          { id: 'custos_resp_tel', label: 'Responsável ciente — Telefone', type: 'text', ph: '(11) 99999-9999' },
